...
const admin=readFileSync("src/admin-dashboard.js","utf8");
...
expect(!admin.includes('name="robots" content="noindex'),"Yönetim HTML'i noindex meta kullanmamalı; Access + robots.txt yeterli");
...
expect(metrics.counts.stagedIssues===0,`Public teknik arıza borcu kalamaz: ${metrics.counts.stagedIssues}`);
